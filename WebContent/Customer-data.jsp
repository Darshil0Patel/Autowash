                            ...
                            <li  class="mm-active"      >
                                ...
                                <ul      >
                                    ...
                                    <li  >
                                        ...
                                        <ul  >
                                            <li>
                                                <a href="adminpending.jsp"> <i
													class="metismenu-icon"></i>Pending Services
											</a>
											</li>
                                            <li>
                                ...
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <input type = "hidden" name="lname" value=<%=c.getLname() %> >
                                            <input type = "hidden" name="email" value=<%=c.getEmail() %> >
                                            <input type = "hidden" name="password" value=<%=c.getPassword() %> >
                                            <button  name="action" value="updatecustomerpage" class="btn btn-success">Update</button>
                                            ...
                                            <input type = "hidden" name="email" value=<%=c.getEmail() %> >
                                            <input type = "hidden" name="password" value=<%=c.getPassword() %> >
                                            <button  name="action" value="deletecustomerpage" class="btn btn-danger">Delete</button>
                                            <!-- <button name="action" value="deletecustomerpage">Delete</button> -->
                                            </form>
                                            </td>
                                        </tr>
