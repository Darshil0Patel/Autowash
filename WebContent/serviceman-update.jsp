...
<html lang="en">
    ...
    <%
    		...
    		if(session!=null)
    		{
    			...
    			{
    				s = (ServiceMan)session.getAttribute("abc");
    			}
    			else
    			{
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="serviceman-service.jsp" class="nav-item nav-link">Service</a>
                            ...
                            <a href="contact.jsp" class="nav-item nav-link">Contact</a>
                             <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="serviceman-update.jsp" class="dropdown-item">Update</a>
                    ...
                    <div class="col-md-7">
                        <div class="contact-form">
                            ...
                            <form method="post" action="ServiceManController">
                                ...
                                <div class="control-group">
                                    <input type="text" class="form-control" name="serviceID" required="required" value=<%=s.getServiceID() %>>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                    <input type="text" class="form-control" name="fname"  required="required" value=<%=s.getFname()%> >
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                    <input type="text" class="form-control" name="lname"  required="required" value=<%=s.getLname() %>>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                    <input type="email" class="form-control" name="email"  required="required" value=<%=s.getEmail() %>>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                    <input type="text" class="form-control" name="password"  required="required" value=<%=s.getPassword() %>>
                                    <p class="help-block text-danger"></p>
                                </div>
                                 <div class="control-group">
                                    <input type="text" class="form-control" name="service"  required="required" value=<%=s.getService() %>>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div>
