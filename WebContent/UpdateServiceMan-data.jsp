...
<link href="admin/main.d810cf0ae7f39f28f336.css" rel="stylesheet"></head>

<body>
    
    <%	
    	ServiceMan sm = (ServiceMan)request.getAttribute("sc");
            ...
            <div class=" bg-premium-dark">
                <div class="d-flex justify-content-center align-items-center">
                    <div class="mx-auto app-login-box col-md-8">
                        <div style="margin-top: 30px;" class="app-logo-inverse mx-auto mb-3"></div>
                        <div class="modal-dialog w-100">
                            ...
                            <div class="modal-content">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="id" id="exampleEmail" value=<%=sm.getId() %> placeholder="ID here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="serviceID" id="exampleEmail" value=<%=sm.getServiceID() %> placeholder="ID here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="fname" id="exampleEmail" value=<%=sm.getFname() %> placeholder="First Name here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="lname" id="exampleName" value=<%=sm.getLname() %> placeholder="Last Name here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="email"  id="examplePassword" value=<%=sm.getEmail() %> placeholder="Email here..." type="email"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="password" id="examplePasswordRep" value=<%=sm.getPassword() %> placeholder="Password here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="service" id="examplePasswordRep" value=<%=sm.getService() %> placeholder="Service here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer d-block text-center">
                                    <button name="action" value="UpdateServiceMan" class="btn-wide btn-pill btn-shadow btn-hover-shine btn btn-primary btn-lg">Update ServiceMan</button>
                                </div>
                            </div>
                            </form>
                        </div>
                        <div style="margin-bottom: 3rem;" class="text-center text-white opacity-8 mt-3">Copyright © ArchitectUI 2019</div>
                    </div>
                </div>
            </div>
        </div>
