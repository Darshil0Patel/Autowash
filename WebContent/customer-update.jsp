...
<html lang="en">
    ...
    <%
    		...
    		if(session!=null)
    		{
    			...
    			{
    				c1 = (Customer)session.getAttribute("abc");
    			}
    			else
    			{
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="customer-update.jsp" class="dropdown-item">Update</a>
                        ...
                        <div class="contact-form">
                            ...
                            <form method="post" action="CustomerController">
                                ...
                                <div class="control-group">
                                	<input type="hidden" class="form-control" name="id"  required="required" value=<%=c1.getId()%> >
                                </div>
                                <div class="control-group">
                                    <input type="text" class="form-control" name="fname"  required="required" value=<%=c1.getFname()%> >
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                    <input type="text" class="form-control" name="lname"  required="required" value=<%=c1.getLname() %>>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                    <input type="email" class="form-control" name="email"  required="required" value=<%=c1.getEmail() %>>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                    <input type="text" class="form-control" name="password"  required="required" value=<%=c1.getPassword() %>>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div>
