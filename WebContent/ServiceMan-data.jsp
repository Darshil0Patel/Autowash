...
<body>
    ...
    <%
   		List<ServiceMan> list = AdminDao.ServiceManData();
   		Admin a3 = null;
                        ...
                        <div class="card mb-3">
                            <div class="card-header-tab card-header">
                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i
                                        class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>ServiceMan Table
                                </div>
                                ...
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <input type = "hidden" name="serviceID" value=<%=sm.getServiceID() %> >
                                            <input type = "hidden" name="fname" value=<%=sm.getFname() %> >
                                            <input type = "hidden" name="lname" value=<%=sm.getLname() %> >
                                            <input type = "hidden" name="email" value=<%=sm.getEmail() %> >
                                            <input type = "hidden" name="password" value=<%=sm.getPassword() %> >
                                            <input type = "hidden" name="service" value=<%=sm.getService() %> >
                                            <button name="action" value="updateservicemanpage" class="btn btn-success">Update</button>
                                            <!-- <button name="action" value="updateservicemanpage">Update</button> -->
                                            </form>
                                            </td>
                                            <td>
                                            <form action="AdminController" method="post">
                                            ...
                                            <input type = "hidden" name="password" value=<%=sm.getPassword() %> >
                                            <input type = "hidden" name="service" value=<%=sm.getService() %> >
                                            <button name="action" value="deleteservicemanpage" class="btn btn-danger">Delete</button>
                                            <!-- <button name="action" value="deleteservicemanpage">Delete</button> -->
                                            </form>
                                            </td>
                                        </tr>
                                    </tbody>
