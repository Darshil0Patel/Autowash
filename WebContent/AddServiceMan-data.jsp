...
<body>
    ...
    <%
   		List<Customer> list = AdminDao.CustomerData();
   		Admin a3 = null;
   		...
   		if(session!=null)
   		{
   			...
   			{
   				a3 = (Admin)session.getAttribute("abc");	
   			}
   			else
   			{
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-secondary">
                                        <div class="menu-header-image opacity-5" style="background-image: url('admin/assets/images/dropdown-header/abstract2.jpg');"></div>
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-rounded dropdown-menu-lg rm-pointers dropdown-menu">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-success">
                                        <div class="menu-header-image opacity-1" style="background-image: url('admin/assets/images/dropdown-header/abstract3.jpg');"></div>
                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-info">
                                                    <div class="menu-header-image opacity-2" style="background-image: url('admin/assets/images/dropdown-header/city3.jpg');"></div>
                                                    <div class="menu-header-content text-left">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                ...
                                <div class="widget-content-left  ml-3 header-user-info">
                                    <div class="widget-heading"> <%= "Welcome, "+a3.getName().toUpperCase() %> </div>
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li  class="mm-active"      >
                                ...
                                <ul      >
                                    <li>
                                        <a href="Customer-data.jsp"  class="mm-active" >
                                            <i class="metismenu-icon"></i>Customer
                                        </a>
                                    </li>
                                    <li>
                                        <a href="ServiceMan-data.jsp" >
                                            <i class="metismenu-icon"></i>ServiceMan
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li  >
                                        <a href="#">
                                            <i class="metismenu-icon"></i> Status
                                            <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                        </a>
                                        <ul  >
                                            <li>
                                                <a href="adminpending.jsp" >
                                                    <i class="metismenu-icon"></i>Pending Services
                                                </a>
                                            </li>
                                            <li>
                                                <a href="adminapproved.jsp" >
                                                    <i class="metismenu-icon"></i>Approved Services
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <li  
                                ...
                                <ul  
                                    ...
                                    <li  >
                                        ...
                                        <ul  >
                                            <li>
                                                <a href="AddCustomer-data.jsp" >
                                                    <i class="metismenu-icon"></i>Add Customer
                                                </a>
                                            </li>
                                            <li>
                                                <a href="AddServiceMan-data.jsp" >
                                                    <i class="metismenu-icon"></i>Add ServiceMan
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                        ...
                        <%-- <div class="card mb-3">
                            <div class="card-header-tab card-header">
                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i
                                        class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>Customer Table
                                </div>
                            ...
                            <div>
                                <form action="AdminController" method="post">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="exampleEmail" class=""><span class="text-danger">*</span>Service ID</label>
                                                <input name="serviceID" id="exampleEmail" placeholder="Service ID" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="exampleEmail" class=""><span class="text-danger">*</span>First Name</label>
                                                <input name="fname" id="exampleEmail" placeholder="First Name" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="exampleName" class="">Last Name</label>
                                                <input name="lname" id="exampleName" placeholder="Last Name" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="examplePassword" class=""><span class="text-danger">*</span> Email</label>
                                                <input name="email" id="examplePassword" placeholder="Email" type="email" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="examplePasswordRep" class=""><span class="text-danger">*</span> Password</label>
                                                <input name="password" id="examplePasswordRep" placeholder="Password" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="examplePasswordRep" class=""><span class="text-danger">*</span> Service</label>
                                                <input name="service" id="examplePasswordRep" placeholder="Service" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 d-flex align-items-center">
                                        <h5 class="mb-0">Already have an account? <a href="javascript:void(0);" class="text-primary">Login</a></h5>
                                        <div class="ml-auto">
                                            <button class="btn-wide btn-pill btn-shadow btn-hover-shine btn btn-primary btn-lg" name="action" value="addServiceMan">Add ServiceMan</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark"
                                        ...
                                        <div class="slide-img-bg"
                                            style="background-image: url('admin/assets/images/originals/citynights.jpg');"></div>
...
<script type="text/javascript" src="admin/assets/scripts/main.d810cf0ae7f39f28f336.js"></script>
    ...
    <div class="app-drawer-overlay d-none animated fadeIn"></div><script type="text/javascript" src="admin/assets/scripts/main.d810cf0ae7f39f28f336.js"></script></body>
