...
<html lang="en">
    ...
    <body>
        ...
        <%
    		...
    		List<pending> list = CustomerDao.showpendinglist(c.getId());
    		List<approved> list1 = CustomerDao.showapprovedlist(c.getId());
    	%>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="status.jsp" class="nav-item nav-link active">Status</a>
                        </div>
                        <div class="ml-auto">
        ...
        <div class="row" style="margin-top: 10px;">
        	<div class="col-sm-12" style="background-color:red; text-align: center; margin-top: 10px;">
        ...
        <table class="table">
		  <thead>
		    <tr>
		      ...
		      <th scope="col">ServiceMan Email</th>
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><%=p1.getCid() %></td>
		      <td><%=p1.getSid() %></td>
		      <td><%=p1.getCfname()+" "+p1.getClname() %></td>
		      <td><%=p1.getSfname()+" "+p1.getSlname() %></td>
		      <td><%=p1.getSemail() %></td>
		      <td><%=p1.getService() %></td>
		    </tr>
		  </tbody>
		...
		<div class="row" style="margin-top: 10px;">
        	<div class="col-sm-12" style="background-color:green; text-align: center; margin-top: 10px;">
		...
		<button type="button" class="btn btn-primary btn-lg" href="">Confirm Serviceman</button>
        </div> --%>
        <!-- Team Start -->
        <%-- <div class="team">
            <div class="container">
