...
<body>
    ...
    <%	
    	Customer c = (Customer)request.getAttribute("cs");
                        ...
                        <div class="modal-dialog w-100">
                            ...
                            <div class="modal-content">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="id" id="exampleEmail" value=<%=c.getId() %> placeholder="ID here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="fname" id="exampleEmail" value=<%=c.getFname() %> placeholder="First Name here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="lname" id="exampleName" value=<%=c.getLname() %> placeholder="Last Name here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="email"  id="examplePassword" value=<%=c.getEmail() %> placeholder="Email here..." type="email"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="password" id="examplePasswordRep" value=<%=c.getPassword() %> placeholder="Password here..." type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer d-block text-center">
                                    <button name="action" value="UpdateCustomer" class="btn-wide btn-pill btn-shadow btn-hover-shine btn btn-primary btn-lg">Update Customer</button>
                                </div>
                            </div>
                            </form>
                        </div>
